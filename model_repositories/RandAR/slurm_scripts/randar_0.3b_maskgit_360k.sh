...
#SBATCH --job-name=randar_0.3b_maskgit_360k
#SBATCH --time=48:00:00      ## hh:mm:ss for the job
### GPU options ###
#SBATCH --gpus-per-node=4
#SBATCH --mail-user=EMAIL
#SBATCH -o ./slurm_logs/randar_0.3b_maskgit_360k.out

# Extracted latent codes
# The following moves the data to the faster compute nodes
cp /work/nvme/bbsg/ziqip2/Datasets/imagenet/imagenet-maskgit-adm-256_codes.tar /tmp
cd /tmp
tar -xf imagenet-maskgit-adm-256_codes.tar
...
mkdir /tmp/randar_0.3b_maskgit_360k_bs_1024_lr_0.0004/
mkdir /tmp/randar_0.3b_maskgit_360k_bs_1024_lr_0.0004/checkpoints/
cp -r /work/hdd/bcnt/ziqip2/ARGen/training_ckpts/randar_0.3b_maskgit_360k_bs_1024_lr_0.0004/* /tmp/randar_0.3b_maskgit_360k_bs_1024_lr_0.0004/checkpoints/

accelerate launch --mixed_precision=bf16 --multi_gpu \
    train_c2i.py --exp-name randar_0.3b_maskgit_360k \
    --config configs/randar/randar_l_0.3b_maskgit.yaml \
    --data-path /tmp/imagenet-maskgit-adm-256_codes \
