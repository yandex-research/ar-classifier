...
#SBATCH --job-name=randar_0.7b_llamagen_360k
#SBATCH --time=48:00:00      ## hh:mm:ss for the job
### GPU options ###
#SBATCH --gpus-per-node=4
#SBATCH --mail-user=EMAIL
#SBATCH -o ./slurm_logs/randar_0.7b_llamagen_360k.out
...
mkdir /tmp/randar_0.7b_llamagen_360k_bs_1024_lr_0.0004/
mkdir /tmp/randar_0.7b_llamagen_360k_bs_1024_lr_0.0004/checkpoints/
cp -r /work/hdd/bcnt/ziqip2/ARGen/training_ckpts/randar_0.7b_llamagen_360k_bs_1024_lr_0.0004/* /tmp/randar_0.7b_llamagen_360k_bs_1024_lr_0.0004/checkpoints/
